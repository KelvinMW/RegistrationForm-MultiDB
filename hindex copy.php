<?php
/*
Using these three tables, I want PHP code that shows dropdown list to allow selecting gibbonYearGroup, gibbonFormGroup for the gibbonSchoolYear with status as Current. The dropdown list of gibbonYearGroup.name and gibbonFormGroup.name will be based on the selected database since they all have the same schema. The following are the tables:
